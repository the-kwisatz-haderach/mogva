...
export const experienceTags = new Map<string, ExperienceKey[]>([
	...
	['CSS', ['highlight', 'ingkaFavourites', 'helioSpectra', 'qlikLicenses', 'systecon', 'salt']],
	['SASS', []],
	['Puppeteer', []],
...
const experiencesConfig = {
	ingkaFavourites: {
		...
		text: [
			...
			'- Completing a migration from CRA to NextJS.',
			'- Setting up a multi-regional cloud infrastructure. (Artifact management, cloud run services, IAM, load balancer, monitoring and alerting etc.)',
			'- Developing CI workflows using github actions, including workflows for release & deploy, rollback, PR environments, testing etc.',
			'- Developing new features through TDD and experimentation using Optimizely.'
		],
		tags: []
	},
	qlikLicenses: {
		...
		text: [
			...
			'In addition to building, testing, documenting and maintaining the frontend application, other tasks include creating workflows in CircleCI, creating an e2e test structure with Cypress and docker-compose, setting up auto-generation of Typescript models and api clients based on Open API specifications from different repositories.',
	...
	systecon: {
		...
		text: [
			'During my tenure I worked with front-end development in two projects, both being React applications where users create, edit and analyze hierarchical (tree-like) data.',
			...
			'I worked in a team with five other developers, following scrum/kanban. Apart from development I was also involved in design decisions regarding the UI/UX, using FIgma for maintaining an interactive mockup.'
		],
		tags: []
	},
	salt: {
	...
	bwProducer: {
		...
		subtitle: 'Bombayworks - Stockholm, Sweden',
		text: [
			'As a digital producer, I managed web projects, making sure they were delivered within time and budget constraints. I made sure projects were well-planned, team members were motivated, and requirements refined and understood by everyone. I was involved in the initial estimation of time and cost, and negotiations prior to project execution. Manual software testing, conversion optimisation, as well as UX and design work, was also sporadically part of my responsibilities. Teams consisted of web designers, web developers, and testers based in both Sweden and India.'
		],
		tags: []
	}
